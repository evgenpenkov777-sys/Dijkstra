...
st.title("Визуализация алгоритма Дейкстры")
...
try:
    st.image("dijkstra.png", use_container_width=True)
except Exception:
    st.info("Если хотите картинку сверху, положите в проект файл dijkstra.png")
